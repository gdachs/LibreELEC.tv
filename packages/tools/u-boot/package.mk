...
make_target() {
  ...
  for UBOOT_TARGET in $UBOOT_CONFIG; do
    if [ "$TARGET_ARCH" = "aarch64" ]; then
      ...
      make CROSS_COMPILE=aarch64-linux-gnu- ARCH=arm mrproper
      make CROSS_COMPILE=aarch64-linux-gnu- ARCH=arm $UBOOT_TARGET
      make CROSS_COMPILE=aarch64-linux-gnu- ARCH=arm HOSTCC="$HOST_CC" HOSTSTRIP="true"
    else
